            ...
            <div className="flex">
                <div className="w-full md:w-2/3 flex flex-col md:mr-8">
                    ...
                    <div className="flex pb-6 justify-start items-center ">
                        <a href="https://github.com/BaileyKH" target="_blank"><IconBrandGithub stroke={1} className="w-12 h-12 pr-1 cursor-pointer" alt="github logo"/></a>
                        <a href="https://www.linkedin.com/in/baileykh/" target="_blank"><IconBrandLinkedin stroke={1} className="w-12 h-12" alt="linked-in logo"/></a>
                    </div>
